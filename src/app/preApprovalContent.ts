...
<div id="ctbs-hero-search"><a href="/get-started/" style="display:inline-flex;align-items:center;gap:10px;background:#2f5d4e;color:#fff;font-size:16.5px;font-weight:500;padding:16px 26px;border-radius:5px;text-decoration:none">Check your address &rarr;</a></div>
</div>
