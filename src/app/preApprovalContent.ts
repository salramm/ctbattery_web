...
<p style="margin:0 0 20px;max-width:48ch;font-size:17px;line-height:1.6;color:#3a3a37;text-wrap:pretty">Five fields, one of them required. No account numbers, no Social Security number, no income, no documents.</p>
...
<section style="padding:clamp(48px,6vw,80px) 0;border-bottom:1px solid #e5e3dc">
<div style="max-width:1120px;margin:0 auto;padding:0 clamp(20px,5vw,56px)">
<p style="margin:0 0 14px;font-family:'JetBrains Mono',ui-monospace,monospace;font-size:11px;font-weight:500;letter-spacing:.13em;text-transform:uppercase;color:#6b6b66">Questions</p>
<h2 style="margin:0 0 32px;font-family:'DM Serif Display',Georgia,serif;font-weight:400;font-size:clamp(26px,2.8vw,38px);line-height:1.18;letter-spacing:-.01em;text-wrap:pretty">What people ask first.</h2>
...
<p style="margin:0;padding:0 0 20px;font-size:16.5px;line-height:1.65;color:#3a3a37;text-wrap:pretty">Under the third-party ownership model the program allows, the provider owns and maintains it for the term and the household has the use of it. Specifics would be written into an agreement you'd read before signing.</p>
</details>
<details style="border-bottom:1px solid #d8d6ce">
<summary style="list-style:none;cursor:pointer;padding:18px 0;font-size:18px;font-weight:700;line-height:1.4;display:flex;justify-content:space-between;gap:20px;align-items:baseline"><span>How long would it run my house in an outage?</span><span style="font-family:'JetBrains Mono',monospace;font-size:12px;color:#6b6b66;flex:none">▾</span></summary>
<p style="margin:0;padding:0 0 20px;font-size:16.5px;line-height:1.65;color:#3a3a37;text-wrap:pretty">We're not giving you a number, on purpose. It depends on system size, which circuits are backed up, the weather, and your usage. Any figure published today would be a guess dressed as a promise.</p>
</details>
<details style="border-bottom:1px solid #d8d6ce">
<summary style="list-style:none;cursor:pointer;padding:18px 0;font-size:18px;font-weight:700;line-height:1.4;display:flex;justify-content:space-between;gap:20px;align-items:baseline"><span>What equipment would you install?</span><span style="font-family:'JetBrains Mono',monospace;font-size:12px;color:#6b6b66;flex:none">▾</span></summary>
<p style="margin:0;padding:0 0 20px;font-size:16.5px;line-height:1.65;color:#3a3a37;text-wrap:pretty">Equipment would be UL-listed residential storage from an established manufacturer. Manufacturer, model, and size remain subject to final selection upon program approval, so we're not naming a product yet.</p>
</details>
<details>
